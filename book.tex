...
\hypersetup{
  pdftitle={Version Control with Subversion {[}DRAFT{]}},
  pdfauthor={Ben Collins-Sussman; Brian W. Fitzpatrick; C. Michael Pilato},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Version Control with Subversion {[}DRAFT{]}}
\usepackage{etoolbox}
\makeatletter
...
\makeatother
\subtitle{(Compiled from (r1920) 1.8)}
...
\input{tex/appb-svn-for-cvs-users}
\input{tex/appc-webdav}
\input{tex/appd-berkeley-db}
\input{tex/copyright}
\backmatter
\end{document}
